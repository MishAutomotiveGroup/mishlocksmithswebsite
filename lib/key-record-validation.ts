...
export function parseKeyRecordPayload(input: unknown): KeyRecordPayload {
  ...
  return {
    ...
    profileName: textValue(value.profileName, "OEM key profile name", true),
    ...
    addKeyPinMethod,
    addKeyPinSupplier,
    keyCloning: booleanValue(value.keyCloning, "Remote button cloning"),
    ...
    oemKeyInStock: booleanValue(value.oemKeyInStock, "Aftermarket key in stock"),
    oemKeySupplier: textValue(value.oemKeySupplier, "Aftermarket key supplier"),
    universalLeadTime: textValue(value.universalLeadTime, "Universal remote lead time"),
    aftermarketLeadTime: textValue(value.aftermarketLeadTime, "Aftermarket remote lead time"),
    oemPricePence: priceValue(value.oemPricePence, "Aftermarket key price"),
