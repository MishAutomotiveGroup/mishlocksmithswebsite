      ...
      <div className="flex items-center gap-3">
        {hasPhone && (
          <a
            ...
            className="flex-1 flex items-center justify-center gap-2 bg-[#1677FF] text-[#171C22] font-bold text-sm rounded py-3 min-h-[52px] hover:bg-[#0D63DA] transition-colors active:scale-[0.99]"
